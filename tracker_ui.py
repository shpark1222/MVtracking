...
class ValveTracker(QtWidgets.QMainWindow):
    def __init__(
        ...
        pcmra_ctrl.addWidget(self.chk_segment_labels, 1, 0)
        pcmra_ctrl.addWidget(self.btn_brush, 1, 1)
        pcmra_ctrl.addWidget(self.btn_pcmra_gif, 1, 2)
        pcmra_ctrl.setColumnStretch(5, 1)
        ...
        pcmra_box.addLayout(pcmra_ctrl)
        ...
        vel_ctrl.addWidget(self.btn_vel_gif, 0, 0)
        vel_ctrl.setColumnStretch(1, 1)
